...
class VotanteSiNo(Ciudadano):
        ...
        def Votante(self, mayorEdad, nacionalidad):
        ...
        if dato == True:
            for Ocupaciones in ocupacionDB:
                    ...
                    if self.discapacidad == True:
                        return True
                    elif (self._diferenciaTiempo >= int(AdolescenteEdadDB) and self._diferenciaTiempo < int(mayorEdadDB)) or (self._diferenciaTiempo > int(TerceraEdadDB)):                                     #TerceraEdad                   
